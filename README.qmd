...
#| fig-cap: A histogram of plausible treatment effects that could be responsible for our delta-to-control; with experiment DTC plotted.
...
number_experiments_list = [1,50,200,400,800,2500, 10000, number_simulated_experiments]
...
fig = sp.make_subplots(rows=number_rows, cols=number_cols, 
                       subplot_titles=subplot_titles, vertical_spacing=0.1)
