...
Rate-based metrics are normally distributed; so can we use the normal approximation to verify our results with mean `{python} conversion_rate` and standard_error = `{python} standard_error`.
