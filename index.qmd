...
This simple example shows numpy.random can be used to simulate data. You can use it to build intuition for AB testing and other analysis.

Upcoming papers will show how to extend numpy.random to model sequential testing, Bayesian testing, and other complex processes.
Simulation studies help us understand our problems when closed-form analytical solutions may not be readily available.