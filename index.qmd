...
2. What's the chance of 110 conversions or more?
...
distribution_figure = sp.make_subplots(
    rows=1,
    cols=3,
    subplot_titles=("82 conversions or less", "110 conversions or more", "Between 90 and 110 conversions"),
    vertical_spacing=0.1,
)
...
# for i in range(3):
#  distribution_figure.update_yaxes(title_text=i, row=1, col=i+1, showticklabels=False)
...
distribution_figure.update_layout(
    annotations=[
        dict(text="82 conversions or less", x=0.15, y=1.05, font=dict(size=12), showarrow=False),
        dict(text="110 conversions or more", x=0.5, y=1.05, font=dict(size=12), showarrow=False),
        dict(text="Between 90 and 110 conversions", x=0.85, y=1.05, font=dict(size=12), showarrow=False),
    ]
)
